...
const FAQ = () => {
  ...
  const faqs = [
    ...
    {
      question: 'HOW DO I BUY $MSTR TOKENS?',
      answer: 'CONNECT YOUR WALLET AND CONTRIBUTE USING CRYPTO (ETH, SOL, BTC, BNB, USDT, USDC) OR CREDIT CARD. THE PRESALE HAS 50 TIERS WITH DYNAMIC PRICING.'
    },
    {
      question: 'HOW DO I CLAIM MY TOKENS?',
      answer: 'CLAIM OPENS 7–10 DAYS AFTER THE PRESALE ENDS. YOU\'LL BE ABLE TO CLAIM YOUR TOKENS DIRECTLY THROUGH OUR PLATFORM.'
    },
    {
      question: 'IS THERE A VESTING SCHEDULE?',
      answer: 'NOT FOR PRESALE BUYERS. TEAM AND TREASURY TOKENS ARE VESTED TO ENSURE LONG-TERM COMMITMENT AND STABILITY.'
    },
    {
